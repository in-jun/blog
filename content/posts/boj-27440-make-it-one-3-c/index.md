---
title: "백준 27440번 1로 만들기 3 (C++)"
date: 2024-05-29T19:58:08+09:00
tags: ["백준", "알고리즘", "동적 프로그래밍", "메모이제이션", "BFS"]
description: "백준 27440번 '1로 만들기 3' 문제를 동적 프로그래밍과 메모이제이션을 활용하여 해결하는 방법을 다루며, 10^18 범위의 큰 수를 1로 만드는 최소 연산 횟수를 O(log² n) 시간에 구하는 알고리즘의 원리와 C++ 구현을 상세히 설명한다."
draft: false
---
