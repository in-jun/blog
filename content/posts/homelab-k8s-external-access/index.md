...
이미 Cloudflare로 도메인을 관리하고 있었기 때문에 Cloudflare의 API와 Workers를 활용한 커스텀 DDNS 솔루션을 개발하기로 했으며, 이 방법으로 모든 제한사항을 해결할 수 있었고 와일드카드 도메인과 다중 서브도메인을 손쉽게 관리할 수 있게 되었다.
