---
title: "플로이드-워셜(Floyd-Warshall) 알고리즘 완벽 가이드"
date: 2024-06-17T19:29:50+09:00
tags: ["플로이드-워셜", "Floyd-Warshall", "알고리즘", "최단 경로", "그래프", "동적 프로그래밍"]
description: "1962년 Robert Floyd와 Stephen Warshall이 독립적으로 발표한 플로이드-워셜 알고리즘의 역사부터, 동적 프로그래밍 기반의 점화식과 3중 루프 동작 원리, O(V³) 시간 복잡도 분석, 음수 가중치 처리와 음수 사이클 탐지 방법, 네트워크 지름 계산과 추이적 폐쇄 등 실제 응용까지 포괄적으로 다룬다."
draft: false
---
